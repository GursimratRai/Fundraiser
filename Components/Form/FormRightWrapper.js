    ...
    const uploadFiles = async (e) => {
         ...
         if(Handler.form.story != ""){
            try {
                ...
                console.log('StoryUrl -',Handler.form.story," -- ",added.path);
         ...
         if(Handler.image != null){
            try {
                ...
                console.log('ImageUrl - ',Handler.image," -- ",added.path)
         ...
         if (Handler.uploaded == true){toast.success("Files Uploaded Successfully")}
    }
